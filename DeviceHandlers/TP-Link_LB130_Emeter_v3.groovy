/*
TP-Link LB130 with Energy Monitor Device Handler
...
Supported models and functions:  This device supports the TP-Link LB130 including Energy Monitor Functions.
...
metadata {
    definition (name: "TP-Link LB130 Emeter", namespace: "djg", author: "Dave Gutheinz") {
        capability "Switch"
